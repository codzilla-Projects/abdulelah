<?php
        ...
        <div class="swiper banner3">
            <div class="swiper-wrapper">
                <?php 
                    ...
                    $slider_video     = get_post_meta( $id, 'abdulelah_slider_video', true );
                ?>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-item1 style-4 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                ...
                                <div class="portfolio-content">
                                    ...
                                    <p><?php the_excerpt()?> </p>
                                    <a href="<?php the_permalink(); ?>" class="text-btn"><?php _e('Read More','abdulelah') ?><i class="bi bi-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    // news
    function abdulelah_get_main_news($atts)
    {
        ob_start();
        $x_data = shortcode_atts(
            array(
        ...
        $no_news = $x_data['no_news'];
        $news = abdulelah_get_news($no_news);
        if ($news->have_posts()) : ?>

            <div class="row justify-content-center position-relative">
                <img src="<?= abdulelah_URL.'assets/images/bg/portfolio-vctor.png' ?>" alt="image" class="blog-vector img-fluid">
                        ...
                        <?php while($news->have_posts()): $news->the_post(); ?>
                            <div class="swiper-slide">
                                <div class="single-blog-2 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                                    <img src="<?= get_the_post_thumbnail_url( ) ?>" class="blog-img" alt="image">
                                    <div class="content">
                                        <h4><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
                                        <p class="para"><?php the_excerpt(); ?></p>
                                        <div class="meta">
                                            <i class="bi bi-stopwatch"></i><span><?= get_the_date( 'F j, Y' ) ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    add_shortcode('main_news', 'abdulelah_get_main_news');
