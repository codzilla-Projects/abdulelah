    ...
    <footer class="style-2 ">
        <img src="<?=abdulelah_URL?>assets/images/bg/footer-vectr1.webp" class="footer-vectr1 img-fluid" alt="image">
        <img src="<?=abdulelah_URL?>assets/images/bg/footer-vectr2.webp" class="footer-vectr2 img-fluid" alt="image">
        <div class="footer-top">
            <div class="container">
                <div class="row gy-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <a href="<?php bloginfo('url')?>"><img alt="image" src="<?=get_option('abdulelah_logo_img');?>">"></a>
                            <p>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                        <div class="footer-item">
                            <h5><?php _e('Useful Links','abdulelah') ?></h5>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                        <div class="footer-item">
                            <h5><?php _e('Services','abdulelah') ?></h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h5><?php _e('Contact Us','abdulelah') ?></h5>
                            <ul class="address-list">
                                <?php $location = get_option('abdulelah_location');  
                                    if(!empty($location)) :
                                ?>
                                <li class="text-white">
                                ...
                                <?php endif?>
                                <?php $second_location = get_option('abdulelah_second_location');  
                                ...
                                <?php endif?>
                                <?php $phone = get_option('abdulelah_phone');  
                                    if(!empty($phone)) :
                                ?>
                                <li>
                                ...
                                <?php endif?>
                                <?php $email = get_option('abdulelah_email');  
                                    if(!empty($email)) :
                                ?>
                                <li>
                                    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center g-3">
                    <div class="col-lg-6 d-flex justify-content-lg-center justify-content-center">
                        <p><?php _e('All Right Reserved to','abdulelah') ?> <a href="<?php bloginfo('url') ?>" class="egns-lab"><?php bloginfo('name') ?></a> &copy; <?php the_date('Y')?> 
                    </div>
                </div>
            </div>
        </div>
